...
<div class="dashboard-nav" style="background: linear-gradient(to bottom right, var(--primary-color), #F15A59);">
        ...
        <nav class="dashboard-nav-list ">
            <a href="hod.php" class="dashboard-nav-item active"style="color: #fff;"><i class="fas fa-home"style="color: #fff;"></i>
            Home </a>
        <a
...
.add-event-form form input[type="date"],
.add-event-form form input[type="text"] {
  flex: 1;
  padding: 8px;
  border: 2px solid var(--primary-color);
  border-radius: 4px;
...
.add-event-form form button[type="submit"] {
  padding: 8px 16px;
  background-color: var(--primary-color);
  color: white;
  border: none;
...
.add-event-form form button[type="submit"]:hover {
