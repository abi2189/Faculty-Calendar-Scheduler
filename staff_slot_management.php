...
<div class='dashboard-app'>
        ...
        <div class='dashboard-content'>
            <div class='container'>
                <div class='card'>
                    ...
                    <h1 style="color: var(--primary-color); font-size: 26px;">Slot Management</h1>
       </div>
                    <div class='card-body'>
  ...
  <h2 style="font-size: 25px; color: var(--primary-color); margin-bottom:30px;margin-top:-20px">Appointment Form</h2>
  <form method="post" action="update.php">
    <div class="form-row">
      ...
      <div class="form-column">
        ...
        <select name="slot" required>
          ...
          <option value="1st_slot">1st slot</option>
          <option value="2nd_slot">2nd slot</option>
          <option value="3rd_slot">3rd slot</option>
          <option value="4th_slot">4th slot</option>
          <option value="5th_slot">5th slot</option>
          <option value="6th_slot">6th slot</option>
          <option value="7th_slot">7th slot</option>
          <option value="8th_slot">8th slot</option>
        </select>
      </div>
    </div>
    <div class="form-row">
    ...
    <input  style="background: var(--primary-color);" type="submit" name="submit" value="Submit">
  </form>
</div>
