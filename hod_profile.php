...
<div class="dashboard-nav" style="background: linear-gradient(to bottom right, var(--primary-color), #F15A59);">
        ...
        href="hod_notifications.php" class="dashboard-nav-item "style="color: #fff;"><i style='font-size:24px'style="color: #fff;" class='far'>&#xf0f3;</i>  Notifications </a>
           ...
           <a href="hod_profile.php" class="dashboard-nav-item active"><i class="fas fa-user"></i> Profile </a>
    ...
    <div class="row">
        ...
        <form id="myForm" >
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels" style="font-size:12px">Name</label><input type="text" class="form-control" placeholder="first name" id="name" name="name" value="<?php echo $_SESSION['name']; ?>" readonly></div>
                </div>
                <div class="row mt-3">
